...
Following are the available PPI country tables from the `ppitables` package. This is updated as at 23 May 2018 using information from the PPI [site](https://www.povertyindex.org).
...
+-----+-----------------+-----------------------------------------------------+-----------------+
| 60. | `ppiZMB2017`    | PPIi for Zambia based on Zambia’s 2015 Living       | 2017            |
