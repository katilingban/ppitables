...
Following are the available PPI country tables from the `ppitables` package. This is updated as at 31 December 2018 using information from the PPI [site](https://www.povertyindex.org).
