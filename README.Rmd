...
Following are the available PPI country tables from the `ppitables` package. This is updated as at 11 May 2019 using information from the PPI [site](https://www.povertyindex.org).
