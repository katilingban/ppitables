...
Following are the available PPI country tables from the `{ppitables}` package. This is updated as at 11 April 2023 using information from the PPI [website](https://www.povertyindex.org).
...
If you use the `{ppitables}` package in publications, please cite using the suggested citation provided by a call to the `citation` function as follows:
