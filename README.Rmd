...
Following are the available PPI country tables from the `ppitables` package. This is updated as at 14 June 2019 using information from the PPI [site](https://www.povertyindex.org).
...
|     |                 | Survey                                              |                 |
+-----+-----------------+-----------------------------------------------------+-----------------+
|     | `ppiMOZ2019`    | PPI for Mozambqiue based on 2014 Inquerito Sobre    | 2019            |
