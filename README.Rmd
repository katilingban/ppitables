...
|                             | and Expenditure Survey                              |                      |
+-----------------------------+-----------------------------------------------------+----------------------+
| 23. `ppi2011KEN`            | PPI for Kenya using Kenya’s 2005/06 Integrated      | 2011                 |
...
+-----------------------------+-----------------------------------------------------+----------------------+
| 40. `ppiPAK2009`            | PPI for Pakistan using Pakistan 2005/6 Social and   |                      |
...
|                             | Household Budget Survey                             |                      |
+-----------------------------+-----------------------------------------------------+----------------------+
| 55. `ppiUGA2015`            | PPI for Uganda based on Uganda's 2012/13 National   | 2015                 |
|                             | Household Survey                                    |                      |
+-----------------------------+-----------------------------------------------------+----------------------+
| 56. `ppiVNM2009`            | PPI for Vietnam based on the 2006 VHLSS             | 2009                 |
+-----------------------------+-----------------------------------------------------+----------------------+
| 57. `ppiYEM2009`            | PPI for Yemen based on 2005/06 HBS                  | 2009                 |
+-----------------------------+-----------------------------------------------------+----------------------+
| 58. `ppiZAF2009`            | PPI for South Africa based on the 2005/6 IES        | 2009                 |
+-----------------------------+-----------------------------------------------------+----------------------+
| 59. `ppiZMB2017`            | PPIi for Zambia based on Zambia’s 2015 Living       | 2017                 |
|                             | Conditions Monitoring Survey (LCMS)                 |                      |
+-----------------------------+-----------------------------------------------------+----------------------+


[^8] Only 59 country PPI tables are shown here and available via the package. There is no lookup table for China because the China Poverty Scorecard is an expert-based scorecard. See [this](https://www.povertyindex.org/china-expert-based-poverty-scorecard) for futher explanation.
